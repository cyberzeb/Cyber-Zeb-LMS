"""
Course Catalog & Content Management module - Pydantic request/response schemas.
...
"""
# TODO(Sprint 2): define schemas for: Course, CourseOffering, Module, Lesson, ContentItem
