...
export function InstructorHelpDeskPage() {
  ...
  if (isError || !data) return <InstructorPageError message="Failed to load help desk tickets." />
  ...
  return (
    <div className="flex flex-col gap-6 md:gap-8">
      <PageHeader
        title="Help Desk"
        subtitle="Get support for technical issues, grading tools, and platform features."
        actions={
      ...
      <Modal
        ...
        description="Priority support for teaching staff."
      ...
      >
        <div className="flex flex-col gap-4">
          ...
          <FormField label="Category" value={form.category} onChange={(v) => setForm((f) => ({ ...f, category: v }))} type="select" options={['Technical', 'Grades', 'Integrations', 'Academic', 'Other']} />
...
export default InstructorHelpDeskPage
