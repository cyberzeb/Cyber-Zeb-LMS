      ...
      <div className="flex flex-col gap-3">
        {campuses.map((campus) => {
          ...
          return (
            <div
              key={campus.id}
              className={`rounded-xl border border-divider/40 bg-white/30 transition-all ${
                    ...
                    <ul className="mt-3 space-y-2">
                      {campusColleges.map((college) => {
                        ...
                        return (
                          <li
                            key={college.id}
                            className="rounded-lg border border-divider/40 bg-white/50"
                          >
                                ...
                                {collegeDepartments.length > 0 ? (
                                  <ul className="space-y-1.5">
                                    {collegeDepartments.map((dept) => (
                                      <li
                                        key={dept.id}
                                        className="flex items-center justify-between gap-2 rounded-md border border-divider/30 bg-white/70 px-2.5 py-2"
                                      >
