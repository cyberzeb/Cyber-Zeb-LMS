...
interface HelpDeskTicketBoardProps {
  assigneeName?: string
  showStats?: boolean
}

export function HelpDeskTicketBoard({ assigneeName = 'Support Team', showStats = true }: HelpDeskTicketBoardProps) {
                    ...
                    <div className="flex justify-end gap-2">
                      ...
                      {ticket.status === 'open' ? (
                        <Button
                          ...
                          size="sm"
                          onClick={() => {
                            updateTicket(ticket.id, { status: 'in-review', assignedTo: assigneeName })
