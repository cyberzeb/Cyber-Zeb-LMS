...
export function StudentCalendarPage() {
  ...
  if (isError || !data) return <StudentPageError message="Failed to load calendar." />

  return (
    <div className="flex flex-col gap-6 md:gap-8">
      <PageHeader
        title="Schedule & Calendar"
        subtitle="Classes, exams, office hours, and deadlines — all in one planner."
        actions={
